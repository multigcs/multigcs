...
void Logging(void) {
	if (logplay == 1) {
		...
		if (last_lat != ModelData[ModelActive].p_lat || last_lon != ModelData[ModelActive].p_long || (int)last_alt != (int)ModelData[ModelActive].p_alt || last_sats != ModelData[ModelActive].numSat) {
			sprintf(line, "GPS;%i.%03i;%f;%f;%f;%f;%i;%i", sec, micros, ModelData[ModelActive].p_lat, ModelData[ModelActive].p_long, ModelData[ModelActive].p_alt - ModelData[ModelActive].alt_offset,
					ModelData[ModelActive].speed, ModelData[ModelActive].gpsfix, ModelData[ModelActive].numSat);
			LogAppend(line);
		...
		if (logflag == 1) {
			logflag = 0;
			sprintf(line, "RC0;%i.%03i;%i;%i;%i;%i;%i;%i;%i;%i", sec, micros, ModelData[ModelActive].radio[0], ModelData[ModelActive].radio[1], ModelData[ModelActive].radio[2], ModelData[ModelActive].radio[3],
					ModelData[ModelActive].radio[4], ModelData[ModelActive].radio[5], ModelData[ModelActive].radio[6], ModelData[ModelActive].radio[7]);
			LogAppend(line);
		}
		if (last_voltage != ModelData[ModelActive].voltage || last_voltage != ModelData[ModelActive].voltage || last_ampere != ModelData[ModelActive].ampere) {
			sprintf(line, "AV0;%i.%03i;%f;%f;%f;%f;%f;%f;%f;%f;%f;%f", sec, micros, ModelData[ModelActive].ampere, ModelData[ModelActive].voltage, ModelData[ModelActive].voltage_zell[0],
					ModelData[ModelActive].voltage_zell[1], ModelData[ModelActive].voltage_zell[2], ModelData[ModelActive].voltage_zell[3], ModelData[ModelActive].voltage_zell[4], ModelData[ModelActive].voltage_zell[5],
					ModelData[ModelActive].temperature[0], ModelData[ModelActive].temperature[1]);
			LogAppend(line);
