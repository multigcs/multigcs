...
static vDescription vdes[VALUES_MAX] = {
	...
	{&simplebgc_setup.roll_invert, "roll_invert", "ROLL_INVERT", TYPE_U8, 0, 1},
	...
	{&simplebgc_setup.pitch_invert, "pitch_invert", "PITCH_INVERT", TYPE_U8, 0, 1},
	...
	{&simplebgc_setup.yaw_invert, "yaw_invert", "YAW_INVERT", TYPE_U8, 0, 1},
	...
	{&simplebgc_setup.roll_rc_lpf, "roll_rc_lpf", "ROLL_RC_LPF", TYPE_U8, 0, 16},
	{&simplebgc_setup.roll_rc_speed, "roll_rc_speed", "ROLL_RC_SPEED", TYPE_U8, 0, 50},
	...
	{&simplebgc_setup.pitch_rc_lpf, "pitch_rc_lpf", "PITCH_RC_LPF", TYPE_U8, 0, 16},
	{&simplebgc_setup.pitch_rc_speed, "pitch_rc_speed", "PITCH_RC_SPEED", TYPE_U8, 0, 50},
	...
	{&simplebgc_setup.yaw_rc_lpf, "yaw_rc_lpf", "YAW_RC_LPF", TYPE_U8, 0, 16},
	{&simplebgc_setup.yaw_rc_speed, "yaw_rc_speed", "YAW_RC_SPEED", TYPE_U8, 0, 50},
	...
	{&simplebgc_setup.use_model, "use_model", "USE_MODEL", TYPE_U8, 0, 1},
	{&simplebgc_setup.pwm_freq, "pwm_freq", "PWM_FREQ", TYPE_U8, 0, 1},
	{&simplebgc_setup.serial_speed, "serial_speed", "SERIAL_SPEED", TYPE_U8, 0, 4},
	...
	{&simplebgc_setup.rc_expo_rate, "rc_expo_rate", "RC_EXPO_RATE", TYPE_U8, 0, 100},
	{&simplebgc_setup.rc_source, "rc_source", "RC_SOURCE", TYPE_U8, 0, 2},
	{&simplebgc_setup.rc_map_roll, "rc_map_roll", "RC_MAP_ROLL", TYPE_U8, 0, 4},
	{&simplebgc_setup.rc_map_pitch, "rc_map_pitch", "RC_MAP_PITCH", TYPE_U8, 0, 4},
	{&simplebgc_setup.rc_map_yaw, "rc_map_yaw", "RC_MAP_YAW", TYPE_U8, 0, 4},
	{&simplebgc_setup.rc_map_cmd, "rc_map_cmd", "RC_MAP_CMD", TYPE_U8, 0, 4},
	{&simplebgc_setup.follow_mode, "follow_mode", "FOLLOW_MODE", TYPE_U8, 0, 2},
	{&simplebgc_setup.follow_deadband, "follow_deadband", "FOLLOW_DEADBAND", TYPE_U8, 0, 255},
	{&simplebgc_setup.follow_expo_rate, "follow_expo_rate", "FOLLOW_EXPO_RATE", TYPE_U8, 0, 100},
	...
	{&simplebgc_setup.axis_top, "axis_top", "AXIS_TOP", TYPE_S8, -3, 3},
	{&simplebgc_setup.axis_right, "axis_right", "AXIS_RIGHT", TYPE_S8, -3, 3},
	{&simplebgc_setup.gyro_lpf, "gyro_lpf", "GYRO_LPF", TYPE_U8, 0, 5},
	{&simplebgc_setup.i2c_internal_pullups, "i2c_internal_pullups", "I2C_INTERNAL_PULLUPS", TYPE_U8, 0, 1},
	{&simplebgc_setup.skip_gyro_calib, "skip_gyro_calib", "SKIP_GYRO_CALIB", TYPE_U8, 0, 1},
	{&simplebgc_setup.rc_cmd_low, "rc_cmd_low", "RC_CMD_LOW", TYPE_U8, 0, 9},
	{&simplebgc_setup.rc_cmd_mid, "rc_cmd_mid", "RC_CMD_MID", TYPE_U8, 0, 9},
	{&simplebgc_setup.rc_cmd_high, "rc_cmd_high", "RC_CMD_HIGH", TYPE_U8, 0, 9},
	{&simplebgc_setup.menu_cmd_1, "menu_cmd_1", "MENU_CMD_1", TYPE_U8, 0, 9},
	{&simplebgc_setup.menu_cmd_2, "menu_cmd_2", "MENU_CMD_2", TYPE_U8, 0, 9},
	{&simplebgc_setup.menu_cmd_3, "menu_cmd_3", "MENU_CMD_3", TYPE_U8, 0, 9},
	{&simplebgc_setup.menu_cmd_4, "menu_cmd_4", "MENU_CMD_4", TYPE_U8, 0, 9},
	{&simplebgc_setup.menu_cmd_5, "menu_cmd_5", "MENU_CMD_5", TYPE_U8, 0, 9},
	{&simplebgc_setup.menu_cmd_long, "menu_cmd_long", "MENU_CMD_LONG", TYPE_U8, 0, 9},
	{&simplebgc_setup.output_roll, "output_roll", "OUTPUT_ROLL", TYPE_U8, 0, 3},
	{&simplebgc_setup.output_pitch, "output_pitch", "OUTPUT_PITCH", TYPE_U8, 0, 3},
	{&simplebgc_setup.output_yaw, "output_yaw", "OUTPUT_YAW", TYPE_U8, 0, 3},
...
void screen_simplebgc (ESContext *esContext) {
	...
	if (select_name[0] != 0) {
		...
		if (mode == 0) {
			...
			draw_text_button(esContext, "_", VIEW_MODE_FCMENU, "I/100", FONT_GREEN, -1.3 + 2 * 0.4, -0.8 + nx * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, simplebgc_select, 0.0);
