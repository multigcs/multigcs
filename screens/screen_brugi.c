...
static uint8_t edit_value (ESContext *esContext, char *name, uint8_t type, BrugiValue *value) {
	...
	draw_text_button(esContext, name, VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, -1.0);
...
void screen_brugi (ESContext *esContext) {
	...
	if (1 == 0) {
		...
		draw_text_button(esContext, "vers", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)0);
		sprintf(tmp_str, "%20s %0.3f", "gyroPitchKp", brugi_setup.gyroPitchKp.value);
		draw_text_button(esContext, "gyroPitchKp", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)1);
		sprintf(tmp_str, "%20s %0.3f", "gyroPitchKi", brugi_setup.gyroPitchKi.value);
		draw_text_button(esContext, "gyroPitchKi", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)2);
		sprintf(tmp_str, "%20s %0.3f", "gyroPitchKd", brugi_setup.gyroPitchKd.value);
		draw_text_button(esContext, "gyroPitchKd", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)3);
		sprintf(tmp_str, "%20s %0.3f", "gyroRollKp", brugi_setup.gyroRollKp.value);
		draw_text_button(esContext, "gyroRollKp", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)4);
		sprintf(tmp_str, "%20s %0.3f", "gyroRollKi", brugi_setup.gyroRollKi.value);
		draw_text_button(esContext, "gyroRollKi", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)5);
		sprintf(tmp_str, "%20s %0.3f", "gyroRollKd", brugi_setup.gyroRollKd.value);
		draw_text_button(esContext, "gyroRollKd", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)6);
		sprintf(tmp_str, "%20s %0.0f", "accTimeConstant", brugi_setup.accTimeConstant.value);
		draw_text_button(esContext, "accTimeConstant", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)7);
		sprintf(tmp_str, "%20s %0.0f", "mpuLPF", brugi_setup.mpuLPF.value);
		draw_text_button(esContext, "mpuLPF", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)8);
		sprintf(tmp_str, "%20s %0.3f", "angleOffsetPitch", brugi_setup.angleOffsetPitch.value);
		draw_text_button(esContext, "angleOffsetPitch", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)9);
		sprintf(tmp_str, "%20s %0.3f", "angleOffsetRoll", brugi_setup.angleOffsetRoll.value);
		draw_text_button(esContext, "angleOffsetRoll", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)10);
		sprintf(tmp_str, "%20s %0.0f", "dirMotorPitch", brugi_setup.dirMotorPitch.value);
		draw_text_button(esContext, "dirMotorPitch", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)11);
		sprintf(tmp_str, "%20s %0.0f", "dirMotorRoll", brugi_setup.dirMotorRoll.value);
		draw_text_button(esContext, "dirMotorRoll", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)12);
		sprintf(tmp_str, "%20s %0.0f", "motorNumberPitch", brugi_setup.motorNumberPitch.value);
		draw_text_button(esContext, "motorNumberPitch", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)13);
		sprintf(tmp_str, "%20s %0.0f", "motorNumberRoll", brugi_setup.motorNumberRoll.value);
		draw_text_button(esContext, "motorNumberRoll", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)14);
		sprintf(tmp_str, "%20s %0.3f", "maxPWMmotorPitch", brugi_setup.maxPWMmotorPitch.value);
		draw_text_button(esContext, "maxPWMmotorPitch", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, -1.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)15);
		n = 0;
		sprintf(tmp_str, "%20s %0.3f", "maxPWMmotorRoll", brugi_setup.maxPWMmotorRoll.value);
		draw_text_button(esContext, "maxPWMmotorRoll", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)16);
		sprintf(tmp_str, "%20s %0.0f", "minRCPitch", brugi_setup.minRCPitch.value);
		draw_text_button(esContext, "minRCPitch", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)17);
		sprintf(tmp_str, "%20s %0.0f", "maxRCPitch", brugi_setup.maxRCPitch.value);
		draw_text_button(esContext, "maxRCPitch", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)18);
		sprintf(tmp_str, "%20s %0.0f", "minRCRoll", brugi_setup.minRCRoll.value);
		draw_text_button(esContext, "minRCRoll", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)19);
		sprintf(tmp_str, "%20s %0.0f", "maxRCRoll", brugi_setup.maxRCRoll.value);
		draw_text_button(esContext, "maxRCRoll", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)20);
		sprintf(tmp_str, "%20s %0.3f", "rcGain", brugi_setup.rcGain.value);
		draw_text_button(esContext, "rcGain", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)21);
		sprintf(tmp_str, "%20s %0.3f", "rcLPF", brugi_setup.rcLPF.value);
		draw_text_button(esContext, "rcLPF", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)22);
		sprintf(tmp_str, "%20s %0.0f", "rcModePPM", brugi_setup.rcModePPM.value);
		draw_text_button(esContext, "rcModePPM", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)23);
		sprintf(tmp_str, "%20s %0.0f", "rcChannelPitch", brugi_setup.rcChannelPitch.value);
		draw_text_button(esContext, "rcChannelPitch", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)24);
		sprintf(tmp_str, "%20s %0.0f", "rcChannelRoll", brugi_setup.rcChannelRoll.value);
		draw_text_button(esContext, "rcChannelRoll", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)25);
		sprintf(tmp_str, "%20s %0.0f", "rcMid", brugi_setup.rcMid.value);
		draw_text_button(esContext, "rcMid", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)26);
		sprintf(tmp_str, "%20s %0.0f", "rcAbsolute", brugi_setup.rcAbsolute.value);
		draw_text_button(esContext, "rcAbsolute", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)27);
		sprintf(tmp_str, "%20s %0.3f", "accOutput", brugi_setup.accOutput.value);
		draw_text_button(esContext, "accOutput", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)28);
		sprintf(tmp_str, "%20s %0.0f", "enableGyro", brugi_setup.enableGyro.value);
		draw_text_button(esContext, "enableGyro", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)29);
		sprintf(tmp_str, "%20s %0.0f", "enableACC", brugi_setup.enableACC.value);
		draw_text_button(esContext, "enableACC", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)30);
		sprintf(tmp_str, "%20s %0.0f", "axisReverseZ", brugi_setup.axisReverseZ.value);
		draw_text_button(esContext, "axisReverseZ", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)31);
		sprintf(tmp_str, "%20s %0.0f", "axisSwapXY", brugi_setup.axisSwapXY.value);
		draw_text_button(esContext, "axisSwapXY", VIEW_MODE_FCMENU, tmp_str, FONT_WHITE, 0.2, -0.8 + n++ * 0.1, 0.002, 0.06, ALIGN_LEFT, ALIGN_TOP, brugi_select, (float)32);
	}

	draw_text_button(esContext, "gyrocal", VIEW_MODE_FCMENU, "Gyro-Calibration", FONT_WHITE, -1.0, 0.9, 0.002, 0.06, ALIGN_CENTER, ALIGN_TOP, brugi_gyrocal, 0.0);
	draw_text_button(esContext, "defaults", VIEW_MODE_FCMENU, "Defaults", FONT_WHITE, -0.3, 0.9, 0.002, 0.06, ALIGN_CENTER, ALIGN_TOP, brugi_defaults, 0.0);
	draw_text_button(esContext, "fload", VIEW_MODE_FCMENU, "Flash-Load", FONT_WHITE, 0.3, 0.9, 0.002, 0.06, ALIGN_CENTER, ALIGN_TOP, brugi_read_from_flash, 0.0);
	draw_text_button(esContext, "fsave", VIEW_MODE_FCMENU, "Flash-Save", FONT_WHITE, 1.0, 0.9, 0.002, 0.06, ALIGN_CENTER, ALIGN_TOP, brugi_save_to_flash, 0.0);
