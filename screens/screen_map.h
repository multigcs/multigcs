...
void show_dir_f(ESContext *esContext, float x1, float y1, float zoom, float lat_from, float lon_from, float alt_from, float lat_to, float lon_to, float alt_to, uint8_t r, uint8_t g, uint8_t b,
				uint8_t a, float *nx1, float *ny1, float *dist);
