...
void screen_wpedit (ESContext *esContext) {
	...
	if (waypoint_active >= 0) {
		...
		draw_text_button(esContext, tmp_str, VIEW_MODE_WPEDIT, "[BACK]", FONT_GREEN, 1.2, -0.9 + (0 * 0.2), 0.002, 0.1, ALIGN_RIGHT, ALIGN_TOP, wpedit_back, 0.0);
...
//		draw_text_button(esContext, "wpedit_lat-", VIEW_MODE_WPEDIT, "[-]", FONT_GREEN, 0.8, -0.9 + (1 * 0.2), 0.002, 0.1, ALIGN_LEFT, ALIGN_TOP, wpedit_waypoint_lat_set, -0.01);
//		draw_text_button(esContext, "wpedit_lat+", VIEW_MODE_WPEDIT, "[+]", FONT_GREEN, 1.2, -0.9 + (1 * 0.2), 0.002, 0.1, ALIGN_RIGHT, ALIGN_TOP, wpedit_waypoint_lat_set, 0.01);
...
//		draw_text_button(esContext, "wpedit_lon-", VIEW_MODE_WPEDIT, "[-]", FONT_GREEN, 0.8, -0.9 + (2 * 0.2), 0.002, 0.1, ALIGN_LEFT, ALIGN_TOP, wpedit_waypoint_lon_set, -0.01);
//		draw_text_button(esContext, "wpedit_lon+", VIEW_MODE_WPEDIT, "[+]", FONT_GREEN, 1.2, -0.9 + (2 * 0.2), 0.002, 0.1, ALIGN_RIGHT, ALIGN_TOP, wpedit_waypoint_lon_set, 0.01);
		...
		draw_text_button(esContext, "wpedit_alt-", VIEW_MODE_WPEDIT, "[-]", FONT_GREEN, 0.8, -0.9 + (3 * 0.2), 0.002, 0.1, ALIGN_LEFT, ALIGN_TOP, wpedit_waypoint_alt_set, -1.0);
		draw_text_button(esContext, "wpedit_alt+", VIEW_MODE_WPEDIT, "[+]", FONT_GREEN, 1.2, -0.9 + (3 * 0.2), 0.002, 0.1, ALIGN_RIGHT, ALIGN_TOP, wpedit_waypoint_alt_set, 1.0);
		...
		draw_text_button(esContext, "wpedit_yaw-", VIEW_MODE_WPEDIT, "[-]", FONT_GREEN, 0.8, -0.9 + (4 * 0.2), 0.002, 0.1, ALIGN_LEFT, ALIGN_TOP, wpedit_waypoint_yaw_set, -1.0);
		draw_text_button(esContext, "wpedit_yaw+", VIEW_MODE_WPEDIT, "[+]", FONT_GREEN, 1.2, -0.9 + (4 * 0.2), 0.002, 0.1, ALIGN_RIGHT, ALIGN_TOP, wpedit_waypoint_yaw_set, 1.0);
		...
		draw_text_button(esContext, "wpedit_cmd", VIEW_MODE_WPEDIT, "[SELECT]", FONT_GREEN, 1.2, -0.9 + (5 * 0.2), 0.002, 0.1, ALIGN_RIGHT, ALIGN_TOP, wpedit_waypoint_type_select, 0.0);
		...
		if (strcmp(WayPoints[waypoint_active].command, "WAYPOINT") == 0) {
			...
			draw_text_button(esContext, "wpedit_wait-", VIEW_MODE_WPEDIT, "[-]", FONT_GREEN, 0.8, -0.9 + (6 * 0.2), 0.002, 0.1, ALIGN_LEFT, ALIGN_TOP, wpedit_waypoint_wait_set, -100.0);
			draw_text_button(esContext, "wpedit_wait+", VIEW_MODE_WPEDIT, "[+]", FONT_GREEN, 1.2, -0.9 + (6 * 0.2), 0.002, 0.1, ALIGN_RIGHT, ALIGN_TOP, wpedit_waypoint_wait_set, 100.0);
			...
			draw_text_button(esContext, "wpedit_radius-", VIEW_MODE_WPEDIT, "[-]", FONT_GREEN, 0.8, -0.9 + (7 * 0.2), 0.002, 0.1, ALIGN_LEFT, ALIGN_TOP, wpedit_waypoint_radius_set, -1.0);
			draw_text_button(esContext, "wpedit_radius+", VIEW_MODE_WPEDIT, "[+]", FONT_GREEN, 1.2, -0.9 + (7 * 0.2), 0.002, 0.1, ALIGN_RIGHT, ALIGN_TOP, wpedit_waypoint_radius_set, 1.0);
			...
			draw_text_button(esContext, "wpedit_orbit-", VIEW_MODE_WPEDIT, "[-]", FONT_GREEN, 0.8, -0.9 + (8 * 0.2), 0.002, 0.1, ALIGN_LEFT, ALIGN_TOP, wpedit_waypoint_orbit_set, -1.0);
			draw_text_button(esContext, "wpedit_orbit+", VIEW_MODE_WPEDIT, "[+]", FONT_GREEN, 1.2, -0.9 + (8 * 0.2), 0.002, 0.1, ALIGN_RIGHT, ALIGN_TOP, wpedit_waypoint_orbit_set, 1.0);
		} else if (strcmp(WayPoints[waypoint_active].command, "TAKEOFF") == 0) {
			sprintf(tmp_str, "PITCH : %0.0f", WayPoints[waypoint_active].wait);
			draw_text_f3(esContext, -1.1, -0.9 + (6 * 0.2), 0.0025, 0.1, 0.1, FONT_GREEN, tmp_str);
			draw_text_button(esContext, "wpedit_pitch-", VIEW_MODE_WPEDIT, "[-]", FONT_GREEN, 0.8, -0.9 + (6 * 0.2), 0.002, 0.1, ALIGN_LEFT, ALIGN_TOP, wpedit_waypoint_wait_set, -1.0);
			draw_text_button(esContext, "wpedit_pitch+", VIEW_MODE_WPEDIT, "[+]", FONT_GREEN, 1.2, -0.9 + (6 * 0.2), 0.002, 0.1, ALIGN_RIGHT, ALIGN_TOP, wpedit_waypoint_wait_set, 1.0);
		}
	}
