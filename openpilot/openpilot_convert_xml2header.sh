...
echo "uint8_t openpilot_change_Openpilot${OBJ_NAME}_${NAME}_${ENAME} (char *name, float x, float y, int8_t button, float data) {"
if test "$RTYPE" = "enum"
then
...
echo "uint8_t openpilot_change_Openpilot${OBJ_NAME}_${NAME} (char *name, float x, float y, int8_t button, float data) {"
if test "$RTYPE" = "enum"
then
	ENUM_MAX="`echo $OPTIONS | tr "," " " | wc -w`"
...
echo ""
echo "uint8_t openpilot_null (char *name, float x, float y, int8_t button, float data) {"
echo "	return 0;"
echo "}"
echo ""
echo "uint8_t openpilot_defaults (char *name, float x, float y, int8_t button, float data) {"
NUM="0"
for XML in $GUIXML
do
...
echo "}"
echo ""
echo "uint8_t openpilot_flash (char *name, float x, float y, int8_t button, float data) {"
echo "	openpilot_save_to_flash();"
echo "	return 0;"
echo "}"
echo ""
echo "uint8_t openpilot_mode (char *name, float x, float y, int8_t button, float data) {"
echo "	if (mode < 2) {"
echo "		mode++;"
echo "	} else {"
echo "		mode = 0;"
...
echo "}"
echo ""
echo "uint8_t openpilot_setup_get (char *name, float x, float y, int8_t button, float data) {"
echo "	openpilot_get = 1;"
echo "	return 0;"
echo "}"
echo ""
echo "uint8_t openpilot_setup_set (char *name, float x, float y, int8_t button, float data) {"
echo "	openpilot_set = 1;"
echo "	return 0;"
echo "}"
echo ""
echo "uint8_t openpilot_down (char *name, float x, float y, int8_t button, float data) {"
echo "	if (page < 0) {"
...
echo "}"
echo ""
echo "uint8_t openpilot_up (char *name, float x, float y, int8_t button, float data) {"
echo "	if (page > -50) {"
echo "		page -= (int8_t)data;"
echo "	}"
echo "	return 0;"
